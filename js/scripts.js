...
window.onload = function() {
	let total = 31; //total number of images
	for(let i=0; i<total; i++) {
		let col = 0;
        if((i+1)/total <= 0.25) {
            col = 0;
        } else if((i+1)/total <=0.5) {
            col = 1;
        } else if((i+1)/total <=0.75) {
            col = 2;
        } else {
            col = 3;
		}
    	let interest = document.getElementsByClassName("column")[col];
        var figure = document.createElement("figure");
        figure.classList.add("snip0016");
        let img = document.createElement("img");

        img.src = "images/portfolio-a/" + i + ".jpeg"; 
    ...
    let totalB = 31; //total number of images
    for(let i=0; i<totalB; i++) {
		let col = 0;
        if((i+1)/totalB <= 0.25) {
            col = 0;
        } else if((i+1)/totalB <=0.5) {
            col = 1;
        } else if((i+1)/totalB <=0.75) {
            col = 2;
        } else {
            col = 3;
		}
    	let interest = document.getElementsByClassName("columnB")[col];
        var figure = document.createElement("figure");
        figure.classList.add("snip0016");
        let img = document.createElement("img");

        img.src = "images/portfolio-b/" + i + ".jpeg"; 
